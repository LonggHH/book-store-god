                ...
                <div class="swiper-slide">
                    <div class="rounded-xl border overflow-hidden">
                        <div style="" class="relative overflow-hidden image-review-slide-scope">
                            <div class="w-full h-full absolute top-0 left-0 bg-no-repeat bg-center bg-cover" style="background-image: url(../assets/images/image/books/book12.png); filter: blur(10px);">                                                    
                            </div>
                            <div class="absolute z-10 w-full h-full flex items-center justify-center">
                                <div style="width: 102px; height: 150px;" class="scope-imgage shadow-lg">
                                    <img style="width: 102px; height: 150px;" src="../assets/images/image/books/book12.png" alt="">
                                </div>
                            </div>
                        </div>
